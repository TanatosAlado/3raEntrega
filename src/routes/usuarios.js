function deslogueo (){
    ...
    .then(response => response.json())
     .then (data=>{
        ...
        document.getElementById("userName").innerHTML=`<div class="titleLogin">Hasta la próxima ${userName} muñe</div>`
     })
...
// routerUsuario.get("/login", loginControl(req, res) , (req, res) => {
